...
<head>
  ...
  <meta name="description" content="Pygame Tutorials - Sprite Module Introduction &amp;#8212; pygame v2.5.2 documentation                                                                        	 	 	   	     	   	  pyga">
<meta property="og:type" content="article">
<meta property="og:title" content="天道酬勤，厚德载物">
<meta property="og:url" content="https://cuiluyi.gitee.io/2024/09/27/[object%20Object]/python/Codes/9.%20%E8%BF%B7%E5%AE%AB%E9%A1%B9%E7%9B%AE/venv/Lib/site-packages/pygame/docs/generated/tut/SpriteIntro/index.html">
<meta property="og:site_name" content="天道酬勤，厚德载物">
<meta property="og:description" content="Pygame Tutorials - Sprite Module Introduction &amp;#8212; pygame v2.5.2 documentation                                                                        	 	 	   	     	   	  pyga">
...
<meta property="article:published_time" content="2024-09-27T04:58:11.684Z">
<meta property="article:modified_time" content="2024-09-27T04:58:11.684Z">
      ...
      <div id="wrapper" class="body-wrap">
        <div class="menu-l">
          ...
          <div id="js-content" class="content-ll">
            <article id="post-python/Codes/9. 迷宫项目/venv/Lib/site-packages/pygame/docs/generated/tut/SpriteIntro" class="article article-type-post " itemscope itemprop="blogPost">
...
<br /><br />
<hr />
<a target="_blank" href="https://github.com/pygame/pygame/edit/main/docs/reST/tut\SpriteIntro.rst" rel="nofollow noopener">Edit on GitHub</a>
    ...
    <div class="declare"> 
      <ul class="post-copyright">
        ...
        <li>
          <strong>本文链接：</strong>
          <a href="https://cuiluyi.gitee.io/2024/09/27/[object Object]/python/Codes/9. 迷宫项目/venv/Lib/site-packages/pygame/docs/generated/tut/SpriteIntro/" title="" target="_blank">https://cuiluyi.gitee.io/2024/09/27/[object Object]/python/Codes/9. 迷宫项目/venv/Lib/site-packages/pygame/docs/generated/tut/SpriteIntro/</a>
        </li>
...
<div class="page-modal wx-share js-wx-box">
    ...
    <p>扫一扫，分享到微信</p>
    <div class="wx-qrcode">
      <img src="//api.qrserver.com/v1/create-qr-code/?size=150x150&data=https://cuiluyi.gitee.io/gitee.io/2024/09/27/[object%20Object]/python/Codes/9.%20%E8%BF%B7%E5%AE%AB%E9%A1%B9%E7%9B%AE/venv/Lib/site-packages/pygame/docs/generated/tut/SpriteIntro/" alt="微信分享二维码">
    </div>
</div>
...
<nav id="article-nav">
    ...
    <a href="/2024/09/27/%5Bobject%20Object%5D/python/Codes/9.%20%E8%BF%B7%E5%AE%AB%E9%A1%B9%E7%9B%AE/venv/Lib/site-packages/pygame/docs/generated/tut/SurfarrayIntro/" id="article-nav-newer" class="article-nav-link-wrap">
    ...
    <a href="/2024/09/27/%5Bobject%20Object%5D/python/Codes/9.%20%E8%BF%B7%E5%AE%AB%E9%A1%B9%E7%9B%AE/venv/Lib/site-packages/pygame/docs/generated/tut/PygameIntro/" id="article-nav-older" class="article-nav-link-wrap">
        ...
        <div class="toc-container tooltip-left">
            ...
            <div class="tooltip tooltip-east">
                ...
                <span class="tooltip-content">
                    ...
                    <ol class="toc"><li class="toc-item toc-level-5"><a class="toc-link"><span class="toc-number">1.</span> <span class="toc-text">pygame documentation</span></a></li></ol></li></ol></li></ol></li><li class="toc-item toc-level-2"><a class="toc-link" href="#sprite-module-introduction"><span class="toc-number"></span> <span class="toc-text">Sprite Module Introduction</span></a><ol class="toc-child"><li class="toc-item toc-level-3"><a class="toc-link" href="#history-lesson"><span class="toc-number"></span> <span class="toc-text">History Lesson</span></a></li><li class="toc-item toc-level-3"><a class="toc-link" href="#the-classes"><span class="toc-number"></span> <span class="toc-text">The Classes</span></a></li><li class="toc-item toc-level-3"><a class="toc-link" href="#the-sprite-class"><span class="toc-number"></span> <span class="toc-text">The Sprite Class</span></a></li><li class="toc-item toc-level-3"><a class="toc-link" href="#the-group-class"><span class="toc-number"></span> <span class="toc-text">The Group Class</span></a></li><li class="toc-item toc-level-3"><a class="toc-link" href="#mixing-them-together"><span class="toc-number"></span> <span class="toc-text">Mixing Them Together</span></a></li><li class="toc-item toc-level-3"><a class="toc-link" href="#the-many-group-types"><span class="toc-number"></span> <span class="toc-text">The Many Group Types</span></a></li><li class="toc-item toc-level-3"><a class="toc-link" href="#the-rendering-groups"><span class="toc-number"></span> <span class="toc-text">The Rendering Groups</span></a></li><li class="toc-item toc-level-3"><a class="toc-link" href="#collision-detection"><span class="toc-number"></span> <span class="toc-text">Collision Detection</span></a></li><li class="toc-item toc-level-3"><a class="toc-link" href="#common-problems"><span class="toc-number"></span> <span class="toc-text">Common Problems</span></a></li><li class="toc-item toc-level-3"><a class="toc-link" href="#extending-your-own-classes-advanced"><span class="toc-number"></span> <span class="toc-text">Extending Your Own Classes (Advanced)</span></a></li><li class="toc-item toc-level-3"><a class="toc-link"><span class="toc-number"></span> <span class="toc-text">Navigation</span></a>
                    </div>
                </span>
            </div>
        </div>
...
<div id="SOHUCS" sid="python/Codes/9. 迷宫项目/venv/Lib/site-packages/pygame/docs/generated/tut/SpriteIntro" ></div> 
