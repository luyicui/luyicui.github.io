...
<head>
  ...
  <meta name="description" content="Pygame Tutorials - Line By Line Chimp Example &amp;#8212; pygame v2.5.2 documentation                                                                        	 	 	   	     	   	  pyga">
<meta property="og:type" content="article">
<meta property="og:title" content="天道酬勤，厚德载物">
<meta property="og:url" content="https://cuiluyi.gitee.io/2024/09/27/[object%20Object]/python/Codes/9.%20%E8%BF%B7%E5%AE%AB%E9%A1%B9%E7%9B%AE/venv/Lib/site-packages/pygame/docs/generated/tut/ChimpLineByLine/index.html">
<meta property="og:site_name" content="天道酬勤，厚德载物">
<meta property="og:description" content="Pygame Tutorials - Line By Line Chimp Example &amp;#8212; pygame v2.5.2 documentation                                                                        	 	 	   	     	   	  pyga">
...
<meta property="og:image" content="https://cuiluyi.gitee.io/2024/09/27/[object%20Object]/python/Codes/9.%20%E8%BF%B7%E5%AE%AB%E9%A1%B9%E7%9B%AE/venv/Lib/site-packages/pygame/docs/generated/tut/_images/chimpshot.gif">
<meta property="article:published_time" content="2024-09-27T04:58:11.677Z">
<meta property="article:modified_time" content="2024-09-27T04:58:11.677Z">
      ...
      <div id="wrapper" class="body-wrap">
        <div class="menu-l">
          ...
          <div id="js-content" class="content-ll">
            <article id="post-python/Codes/9. 迷宫项目/venv/Lib/site-packages/pygame/docs/generated/tut/ChimpLineByLine" class="article article-type-post " itemscope itemprop="blogPost">
...
<html>
  <head>
    ...
    <title>Pygame Tutorials - Line By Line Chimp Example &#8212; pygame v2.5.2 documentation</title>
...
<br /><br />
<hr />
<a target="_blank" href="https://github.com/pygame/pygame/edit/main/docs/reST/tut\ChimpLineByLine.rst" rel="nofollow noopener">Edit on GitHub</a>
    ...
    <div class="declare"> 
      <ul class="post-copyright">
        ...
        <li>
          <strong>本文链接：</strong>
          <a href="https://cuiluyi.gitee.io/2024/09/27/[object Object]/python/Codes/9. 迷宫项目/venv/Lib/site-packages/pygame/docs/generated/tut/ChimpLineByLine/" title="" target="_blank">https://cuiluyi.gitee.io/2024/09/27/[object Object]/python/Codes/9. 迷宫项目/venv/Lib/site-packages/pygame/docs/generated/tut/ChimpLineByLine/</a>
        </li>
...
<div class="page-modal wx-share js-wx-box">
    ...
    <p>扫一扫，分享到微信</p>
    <div class="wx-qrcode">
      <img src="//api.qrserver.com/v1/create-qr-code/?size=150x150&data=https://cuiluyi.gitee.io/gitee.io/2024/09/27/[object%20Object]/python/Codes/9.%20%E8%BF%B7%E5%AE%AB%E9%A1%B9%E7%9B%AE/venv/Lib/site-packages/pygame/docs/generated/tut/ChimpLineByLine/" alt="微信分享二维码">
    </div>
</div>
...
<nav id="article-nav">
    ...
    <a href="/2024/09/27/%5Bobject%20Object%5D/python/Codes/9.%20%E8%BF%B7%E5%AE%AB%E9%A1%B9%E7%9B%AE/venv/Lib/site-packages/pygame/docs/generated/tut/DisplayModes/" id="article-nav-newer" class="article-nav-link-wrap">
    ...
    <a href="/2024/09/27/%5Bobject%20Object%5D/python/Codes/9.%20%E8%BF%B7%E5%AE%AB%E9%A1%B9%E7%9B%AE/venv/Lib/site-packages/pygame/docs/generated/tut/CameraIntro/" id="article-nav-older" class="article-nav-link-wrap">
        ...
        <div class="toc-container tooltip-left">
            ...
            <div class="tooltip tooltip-east">
                ...
                <span class="tooltip-content">
                    ...
                    <ol class="toc"><li class="toc-item toc-level-5"><a class="toc-link"><span class="toc-number">1.</span> <span class="toc-text">pygame documentation</span></a></li></ol></li></ol></li></ol></li><li class="toc-item toc-level-2"><a class="toc-link" href="#line-by-line-chimp"><span class="toc-number"></span> <span class="toc-text">Line By Line Chimp</span></a><ol class="toc-child"><li class="toc-item toc-level-3"><a class="toc-link" href="#introduction"><span class="toc-number"></span> <span class="toc-text">Introduction</span></a></li><li class="toc-item toc-level-3"><a class="toc-link" href="#import-modules"><span class="toc-number"></span> <span class="toc-text">Import Modules</span></a></li><li class="toc-item toc-level-3"><a class="toc-link" href="#loading-resources"><span class="toc-number"></span> <span class="toc-text">Loading Resources</span></a></li><li class="toc-item toc-level-3"><a class="toc-link" href="#game-object-classes"><span class="toc-number"></span> <span class="toc-text">Game Object Classes</span></a></li><li class="toc-item toc-level-3"><a class="toc-link" href="#initialize-everything"><span class="toc-number"></span> <span class="toc-text">Initialize Everything</span></a></li><li class="toc-item toc-level-3"><a class="toc-link" href="#create-the-background"><span class="toc-number"></span> <span class="toc-text">Create The Background</span></a></li><li class="toc-item toc-level-3"><a class="toc-link" href="#put-text-on-the-background-centered"><span class="toc-number"></span> <span class="toc-text">Put Text On The Background, Centered</span></a></li><li class="toc-item toc-level-3"><a class="toc-link" href="#display-the-background-while-setup-finishes"><span class="toc-number"></span> <span class="toc-text">Display The Background While Setup Finishes</span></a></li><li class="toc-item toc-level-3"><a class="toc-link" href="#prepare-game-object"><span class="toc-number"></span> <span class="toc-text">Prepare Game Object</span></a></li><li class="toc-item toc-level-3"><a class="toc-link" href="#main-loop"><span class="toc-number"></span> <span class="toc-text">Main Loop</span></a></li><li class="toc-item toc-level-3"><a class="toc-link" href="#handle-all-input-events"><span class="toc-number"></span> <span class="toc-text">Handle All Input Events</span></a></li><li class="toc-item toc-level-3"><a class="toc-link" href="#update-the-sprites"><span class="toc-number"></span> <span class="toc-text">Update the Sprites</span></a></li><li class="toc-item toc-level-3"><a class="toc-link" href="#draw-the-entire-scene"><span class="toc-number"></span> <span class="toc-text">Draw The Entire Scene</span></a></li><li class="toc-item toc-level-3"><a class="toc-link" href="#game-over"><span class="toc-number"></span> <span class="toc-text">Game Over</span></a></li><li class="toc-item toc-level-3"><a class="toc-link"><span class="toc-number"></span> <span class="toc-text">Navigation</span></a>
                    </div>
                </span>
            </div>
        </div>
...
<div id="SOHUCS" sid="python/Codes/9. 迷宫项目/venv/Lib/site-packages/pygame/docs/generated/tut/ChimpLineByLine" ></div> 
