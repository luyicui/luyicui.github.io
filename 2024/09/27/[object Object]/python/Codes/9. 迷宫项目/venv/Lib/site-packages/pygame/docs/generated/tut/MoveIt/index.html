...
<head>
  ...
  <meta name="description" content="Pygame Tutorials - Help! How Do I Move An Image? &amp;#8212; pygame v2.5.2 documentation                                                                        	 	 	   	     	   	  p">
<meta property="og:type" content="article">
<meta property="og:title" content="天道酬勤，厚德载物">
<meta property="og:url" content="https://cuiluyi.gitee.io/2024/09/27/[object%20Object]/python/Codes/9.%20%E8%BF%B7%E5%AE%AB%E9%A1%B9%E7%9B%AE/venv/Lib/site-packages/pygame/docs/generated/tut/MoveIt/index.html">
<meta property="og:site_name" content="天道酬勤，厚德载物">
<meta property="og:description" content="Pygame Tutorials - Help! How Do I Move An Image? &amp;#8212; pygame v2.5.2 documentation                                                                        	 	 	   	     	   	  p">
...
<meta property="article:published_time" content="2024-09-27T04:58:11.682Z">
<meta property="article:modified_time" content="2024-09-27T04:58:11.682Z">
      ...
      <div id="wrapper" class="body-wrap">
        <div class="menu-l">
          ...
          <div id="js-content" class="content-ll">
            <article id="post-python/Codes/9. 迷宫项目/venv/Lib/site-packages/pygame/docs/generated/tut/MoveIt" class="article article-type-post " itemscope itemprop="blogPost">
...
<br /><br />
<hr />
<a target="_blank" href="https://github.com/pygame/pygame/edit/main/docs/reST/tut\MoveIt.rst" rel="nofollow noopener">Edit on GitHub</a>
    ...
    <div class="declare"> 
      <ul class="post-copyright">
        ...
        <li>
          <strong>本文链接：</strong>
          <a href="https://cuiluyi.gitee.io/2024/09/27/[object Object]/python/Codes/9. 迷宫项目/venv/Lib/site-packages/pygame/docs/generated/tut/MoveIt/" title="" target="_blank">https://cuiluyi.gitee.io/2024/09/27/[object Object]/python/Codes/9. 迷宫项目/venv/Lib/site-packages/pygame/docs/generated/tut/MoveIt/</a>
        </li>
...
<div class="page-modal wx-share js-wx-box">
    ...
    <p>扫一扫，分享到微信</p>
    <div class="wx-qrcode">
      <img src="//api.qrserver.com/v1/create-qr-code/?size=150x150&data=https://cuiluyi.gitee.io/gitee.io/2024/09/27/[object%20Object]/python/Codes/9.%20%E8%BF%B7%E5%AE%AB%E9%A1%B9%E7%9B%AE/venv/Lib/site-packages/pygame/docs/generated/tut/MoveIt/" alt="微信分享二维码">
    </div>
</div>
...
<nav id="article-nav">
    ...
    <a href="/2024/09/27/%5Bobject%20Object%5D/python/Codes/9.%20%E8%BF%B7%E5%AE%AB%E9%A1%B9%E7%9B%AE/venv/Lib/site-packages/pygame/docs/generated/tut/PygameIntro/" id="article-nav-newer" class="article-nav-link-wrap">
    ...
    <a href="/2024/09/27/%5Bobject%20Object%5D/python/Codes/9.%20%E8%BF%B7%E5%AE%AB%E9%A1%B9%E7%9B%AE/venv/Lib/site-packages/pygame/docs/generated/tut/MakeGames/" id="article-nav-older" class="article-nav-link-wrap">
        ...
        <div class="toc-container tooltip-left">
            ...
            <div class="tooltip tooltip-east">
                ...
                <span class="tooltip-content">
                    ...
                    <ol class="toc"><li class="toc-item toc-level-5"><a class="toc-link"><span class="toc-number">1.</span> <span class="toc-text">pygame documentation</span></a></li></ol></li></ol></li></ol></li><li class="toc-item toc-level-2"><a class="toc-link" href="#help-how-do-i-move-an-image"><span class="toc-number"></span> <span class="toc-text">Help! How Do I Move An Image?</span></a><ol class="toc-child"><li class="toc-item toc-level-3"><a class="toc-link" href="#just-pixels-on-the-screen"><span class="toc-number"></span> <span class="toc-text">Just Pixels On The Screen</span></a></li><li class="toc-item toc-level-3"><a class="toc-link" href="#let-s-go-back-a-step"><span class="toc-number"></span> <span class="toc-text">Let&#39;s Go Back A Step</span></a></li><li class="toc-item toc-level-3"><a class="toc-link" href="#making-the-hero-move"><span class="toc-number"></span> <span class="toc-text">Making The Hero Move</span></a></li><li class="toc-item toc-level-3"><a class="toc-link" href="#creating-a-map"><span class="toc-number"></span> <span class="toc-text">Creating A Map</span></a></li><li class="toc-item toc-level-3"><a class="toc-link" href="#making-the-hero-move-take-2"><span class="toc-number"></span> <span class="toc-text">Making The Hero Move (Take 2)</span></a></li><li class="toc-item toc-level-3"><a class="toc-link" href="#definition-blit"><span class="toc-number"></span> <span class="toc-text">Definition: &quot;blit&quot;</span></a></li><li class="toc-item toc-level-3"><a class="toc-link" href="#going-from-the-list-to-the-screen"><span class="toc-number"></span> <span class="toc-text">Going From The List To The Screen</span></a></li><li class="toc-item toc-level-3"><a class="toc-link" href="#screen-coordinates"><span class="toc-number"></span> <span class="toc-text">Screen Coordinates</span></a></li><li class="toc-item toc-level-3"><a class="toc-link" href="#changing-the-background"><span class="toc-number"></span> <span class="toc-text">Changing The Background</span></a></li><li class="toc-item toc-level-3"><a class="toc-link" href="#smooth-movement"><span class="toc-number"></span> <span class="toc-text">Smooth Movement</span></a></li><li class="toc-item toc-level-3"><a class="toc-link" href="#so-what-next"><span class="toc-number"></span> <span class="toc-text">So, What Next?</span></a></li><li class="toc-item toc-level-3"><a class="toc-link" href="#first-the-mystery-functions"><span class="toc-number"></span> <span class="toc-text">First, The Mystery Functions</span></a></li><li class="toc-item toc-level-3"><a class="toc-link" href="#handling-some-input"><span class="toc-number"></span> <span class="toc-text">Handling Some Input</span></a></li><li class="toc-item toc-level-3"><a class="toc-link" href="#moving-multiple-images"><span class="toc-number"></span> <span class="toc-text">Moving Multiple Images</span></a></li><li class="toc-item toc-level-3"><a class="toc-link" href="#putting-it-all-together"><span class="toc-number"></span> <span class="toc-text">Putting It All Together</span></a></li><li class="toc-item toc-level-3"><a class="toc-link" href="#preparing-for-improved-user-input"><span class="toc-number"></span> <span class="toc-text">Preparing for Improved User Input</span></a></li><li class="toc-item toc-level-3"><a class="toc-link" href="#adding-the-user-input"><span class="toc-number"></span> <span class="toc-text">Adding the User Input</span></a></li><li class="toc-item toc-level-3"><a class="toc-link" href="#putting-it-all-together-one-more-time"><span class="toc-number"></span> <span class="toc-text">Putting it all Together One More time</span></a></li><li class="toc-item toc-level-3"><a class="toc-link" href="#you-are-on-your-own-from-here"><span class="toc-number"></span> <span class="toc-text">You Are On Your Own From Here</span></a></li><li class="toc-item toc-level-3"><a class="toc-link"><span class="toc-number"></span> <span class="toc-text">Navigation</span></a>
                    </div>
                </span>
            </div>
        </div>
...
<div id="SOHUCS" sid="python/Codes/9. 迷宫项目/venv/Lib/site-packages/pygame/docs/generated/tut/MoveIt" ></div> 
