...
<head>
  ...
  <meta name="description" content="A Newbie Guide to pygame &amp;#8212; pygame v2.5.2 documentation                                                                        	 	 	   	     	   	  pygame documentation">
<meta property="og:type" content="article">
<meta property="og:title" content="天道酬勤，厚德载物">
<meta property="og:url" content="https://cuiluyi.gitee.io/2024/09/27/[object%20Object]/python/Codes/9.%20%E8%BF%B7%E5%AE%AB%E9%A1%B9%E7%9B%AE/venv/Lib/site-packages/pygame/docs/generated/tut/newbieguide/index.html">
<meta property="og:site_name" content="天道酬勤，厚德载物">
<meta property="og:description" content="A Newbie Guide to pygame &amp;#8212; pygame v2.5.2 documentation                                                                        	 	 	   	     	   	  pygame documentation">
...
<meta property="article:published_time" content="2024-09-27T04:58:11.688Z">
<meta property="article:modified_time" content="2024-09-27T04:58:11.688Z">
      ...
      <div id="wrapper" class="body-wrap">
        <div class="menu-l">
          ...
          <div id="js-content" class="content-ll">
            <article id="post-python/Codes/9. 迷宫项目/venv/Lib/site-packages/pygame/docs/generated/tut/newbieguide" class="article article-type-post " itemscope itemprop="blogPost">
...
<p><a class="reference external" target="_blank" rel="noopener" href="https://www.pygame.org/">Pygame</a> is a python wrapper for <a class="reference external" target="_blank" rel="noopener" href="http://libsdl.org">SDL</a>, written by Pete Shinners.  What this
...
official <a class="reference external" target="_blank" rel="noopener" href="https://docs.python.org/3/">Python documentation</a>, and Googling error messages to figure out what
they mean.</p>
...
specifically for games, I highly recommend <a class="reference external" target="_blank" rel="noopener" href="https://gameprogrammingpatterns.com/contents.html">Game Programming Patterns</a>, a short
...
unwieldy, chances are its speed can be improved, too.  Read over <a class="reference external" target="_blank" rel="noopener" href="https://blubberquark.tumblr.com/post/630054903238262784/why-pygame-is-slow">Why Pygame is
...
And if you're truly stumped by performance problems, profilers like <a class="reference external" target="_blank" rel="noopener" href="https://docs.python.org/3/library/profile.html">cProfile</a>
(or <a class="reference external" target="_blank" rel="noopener" href="https://jiffyclub.github.io/snakeviz/">SnakeViz</a>, a visualizer for cProfile) can help identify bottlenecks (they'll
...
<br /><br />
<hr />
<a target="_blank" href="https://github.com/pygame/pygame/edit/main/docs/reST/tut\newbieguide.rst" rel="nofollow noopener">Edit on GitHub</a>
    ...
    <div class="declare"> 
      <ul class="post-copyright">
        ...
        <li>
          <strong>本文链接：</strong>
          <a href="https://cuiluyi.gitee.io/2024/09/27/[object Object]/python/Codes/9. 迷宫项目/venv/Lib/site-packages/pygame/docs/generated/tut/newbieguide/" title="" target="_blank">https://cuiluyi.gitee.io/2024/09/27/[object Object]/python/Codes/9. 迷宫项目/venv/Lib/site-packages/pygame/docs/generated/tut/newbieguide/</a>
        </li>
...
<div class="page-modal wx-share js-wx-box">
    ...
    <p>扫一扫，分享到微信</p>
    <div class="wx-qrcode">
      <img src="//api.qrserver.com/v1/create-qr-code/?size=150x150&data=https://cuiluyi.gitee.io/gitee.io/2024/09/27/[object%20Object]/python/Codes/9.%20%E8%BF%B7%E5%AE%AB%E9%A1%B9%E7%9B%AE/venv/Lib/site-packages/pygame/docs/generated/tut/newbieguide/" alt="微信分享二维码">
    </div>
</div>
...
<nav id="article-nav">
    ...
    <a href="/2024/09/27/%5Bobject%20Object%5D/python/Codes/9.%20%E8%BF%B7%E5%AE%AB%E9%A1%B9%E7%9B%AE/venv/Lib/site-packages/pygame/docs/generated/tut/tom_games2/" id="article-nav-newer" class="article-nav-link-wrap">
    ...
    <a href="/2024/09/27/%5Bobject%20Object%5D/python/Codes/9.%20%E8%BF%B7%E5%AE%AB%E9%A1%B9%E7%9B%AE/venv/Lib/site-packages/pygame/docs/generated/tut/chimp.py/" id="article-nav-older" class="article-nav-link-wrap">
        ...
        <div class="toc-container tooltip-left">
            ...
            <div class="tooltip tooltip-east">
                ...
                <span class="tooltip-content">
                    ...
                    <ol class="toc"><li class="toc-item toc-level-5"><a class="toc-link"><span class="toc-number">1.</span> <span class="toc-text">pygame documentation</span></a></li></ol></li></ol></li></ol></li><li class="toc-item toc-level-2"><a class="toc-link" href="#a-newbie-guide-to-pygame"><span class="toc-number"></span> <span class="toc-text">A Newbie Guide to pygame</span></a><ol class="toc-child"><li class="toc-item toc-level-3"><a class="toc-link" href="#get-comfortable-working-in-python"><span class="toc-number"></span> <span class="toc-text">Get comfortable working in Python.</span></a></li><li class="toc-item toc-level-3"><a class="toc-link" href="#recognize-which-parts-of-pygame-you-really-need"><span class="toc-number"></span> <span class="toc-text">Recognize which parts of pygame you really need.</span></a></li><li class="toc-item toc-level-3"><a class="toc-link" href="#know-what-a-surface-is"><span class="toc-number"></span> <span class="toc-text">Know what a surface is.</span></a></li><li class="toc-item toc-level-3"><a class="toc-link" href="#use-surface-convert"><span class="toc-number"></span> <span class="toc-text">Use Surface.convert().</span></a></li><li class="toc-item toc-level-3"><a class="toc-link" href="#be-wary-of-outdated-obsolete-and-optional-advice"><span class="toc-number"></span> <span class="toc-text">Be wary of outdated, obsolete, and optional advice.</span></a></li><li class="toc-item toc-level-3"><a class="toc-link" href="#there-is-no-rule-six"><span class="toc-number"></span> <span class="toc-text">There is NO rule six.</span></a></li><li class="toc-item toc-level-3"><a class="toc-link" href="#don-t-get-distracted-by-side-issues"><span class="toc-number"></span> <span class="toc-text">Don&#39;t get distracted by side issues.</span></a></li><li class="toc-item toc-level-3"><a class="toc-link" href="#rects-are-your-friends"><span class="toc-number"></span> <span class="toc-text">Rects are your friends.</span></a></li><li class="toc-item toc-level-3"><a class="toc-link" href="#don-t-bother-with-pixel-perfect-collision-detection"><span class="toc-number"></span> <span class="toc-text">Don&#39;t bother with pixel-perfect collision detection.</span></a></li><li class="toc-item toc-level-3"><a class="toc-link" href="#managing-the-event-subsystem"><span class="toc-number"></span> <span class="toc-text">Managing the event subsystem.</span></a></li><li class="toc-item toc-level-3"><a class="toc-link" href="#colorkey-vs-alpha"><span class="toc-number"></span> <span class="toc-text">Colorkey vs. Alpha.</span></a></li><li class="toc-item toc-level-3"><a class="toc-link" href="#software-architecture-design-patterns-and-games"><span class="toc-number"></span> <span class="toc-text">Software architecture, design patterns, and games.</span></a></li><li class="toc-item toc-level-3"><a class="toc-link" href="#do-things-the-pythony-way"><span class="toc-number"></span> <span class="toc-text">Do things the pythony way.</span></a></li><li class="toc-item toc-level-3"><a class="toc-link"><span class="toc-number"></span> <span class="toc-text">Navigation</span></a>
                    </div>
                </span>
            </div>
        </div>
...
<div id="SOHUCS" sid="python/Codes/9. 迷宫项目/venv/Lib/site-packages/pygame/docs/generated/tut/newbieguide" ></div> 
